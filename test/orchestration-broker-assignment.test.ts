...
describe('V3 broker assignment evidence', () => {
  ...
  it('finds assignment evidence inside the current COS activeRuns snapshot shape', () => {
    const marker = assignmentMarker('34343434-3434-4434-8434-343434343434');
    const snapshot = {
      ...base,
